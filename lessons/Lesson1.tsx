...
const lesson1GrammarRules = [
    ...
    { title: "Darak (+)", structure: "I / You + Fe'l", example: `I <span class="font-bold">watch</span> TV.`, color: 'green' as const },
    { title: "Inkor (-)", structure: "I / You + don't + Fe'l", example: `I <span class="font-bold">don't watch</span> TV.`, color: 'red' as const },
    { title: "So'roq (?)", structure: "Do you + Fe'l...?", example: `<span class="font-bold">Do you watch</span> TV?`, color: 'sky' as const }
];

export const Lesson1 = (container: HTMLElement) => {
    ...
    header.innerHTML = `
        <h1 class="text-4xl md:text-5xl font-bold text-blue-800">1-Dars: Uy va Kundalik Ishlar</h1>
        <p class="mt-4 text-lg text-gray-600">"Uy" mavzusidagi iboralarni o'rganing va interaktiv mashqlar bajaring.</p>
    `;
