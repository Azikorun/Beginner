...
const lesson17GrammarRules = [
    { title: "In (Ichida)", structure: "in + yopiq joy", example: `Biror narsaning ichidagi joylashuv. The keys are <span class="font-bold">in the box</span>.`, color: 'green' as const },
    { title: "On (Ustida)", structure: "on + sirt", example: `Biror narsaning sirti ustidagi joylashuv. The book is <span class="font-bold">on the table</span>.`, color: 'sky' as const },
    { title: "Under (Ostida)", structure: "under + narsa", example: `Biror narsaning pastidagi joylashuv. The cat is <span class="font-bold">under the chair</span>.`, color: 'red' as const },
];

export const Lesson17 = (container: HTMLElement) => {
    container.innerHTML = '';
    ...
    header.innerHTML = `
        <h1 class="text-4xl md:text-5xl font-bold text-blue-800">17-Dars: Joy Predloglari (In, On, Under)</h1>
        <p class="mt-4 text-lg text-gray-600">Narsalarning qayerda ekanligini aytish uchun eng kerakli predloglarni o'rganing.</p>
    `;
